...
for f in $( ls *.pickle ); do
    echo Processing: $f
    # python /scratch/gpfs/WINGREEN/ziyangc/PASA/CellModeller/Scripts/Draw2DPDF.py $f
    python /scratch/gpfs/WINGREEN/ziyangc/PASA/CellModeller/Scripts/Draw_2molecules.py $f
